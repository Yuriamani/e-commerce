...
import { House, Wallet, Settings, ShoppingBag, Menu, Store, ShoppingCart, FileStack, Star } from "lucide-react";
...
const SIDEBAR_ITEMS = [
	...
	{ name: "My Cart", icon: ShoppingCart, color: "#F59E0B", href: "/cart" },
	{ name: "History", icon: FileStack, color: "#3B82F6", href: "/history" },
